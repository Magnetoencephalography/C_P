...
SET_FILENAME='SAF_seq4_circle2_notch_otp_ica_raw_tsss.fif' #Raw data filename
######################################################
global SET_COVNAME
SET_COVNAME='room_notch_otp_raw_tsss-cov.fif'
global SET_EVENAME
SET_EVENAME='SAF_seq4_circle2_raw_ica_tsss-eve.fif'
global SET_FWDNAME
SET_FWDNAME='SAF_seq4_circle2_raw-fwd.fif'
global SET_INVNAME
SET_INVNAME='SAF_seq4_circle2_raw-inv.fif'
global SET_EVENTID
SET_EVENTID='2,3,4'
